export const events = [
  ...
  },
  {
    ...
    comment:
      "Nulla porttitor accumsan tincidunt. Curabitur aliquet quam id dui. If you are going to use a passage of Lorem Ipsum",
  ...
  },
  {
    ...
    theme:
      "If you are going to use a passage of Lorem Ipsum, you need to be sure ther.",
    comment:
      "If you are going to use a passage of Lorem Ipsum, you need to be sure there isnt anything embarrassing hidden in the middle of text.",
    date: "2022-04-19T13:03:25.753Z",
    favorite: false,
